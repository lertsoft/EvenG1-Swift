...
final class G1NavigationGestureMappingTests: XCTestCase {
    func testGestureMappingsWhenNavigationIsActive() {
        ...
        XCTAssertNil(G1NavigationGestureMapper.action(for: .pressAndHold, isNavigationActive: true))
        XCTAssertNil(G1NavigationGestureMapper.action(for: .pressAndRelease, isNavigationActive: true))
